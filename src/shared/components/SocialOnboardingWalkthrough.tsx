...
const STEPS: Step[] = [
  {
    id: "step-1",
    title: "Selamat Datang di Wanderer! 🦊",
    emoji: "🧭",
    subtitle: "Peta Eksplorasi Sosial Premium",
    description: "Jelajahi dunia di sekitar Anda. Langkah kaki Anda akan menyapu kabut di peta secara otomatis seiring Anda bergerak!",
    gradient: ["#FF5E62", "#FF9966"],
  },
  {
    id: "step-2",
    title: "Realtime Friend Radar 📍",
    emoji: "👥",
    subtitle: "Selalu Terkoneksi Secara Emosional",
    description: "Pantau posisi teman Anda secara langsung. Lihat aktivitas mereka: sedang berkendara, berjalan kaki, atau bersantai di rumah.",
    gradient: ["#00F2FE", "#4FACFE"],
  },
  {
    id: "step-3",
    title: "Menjaga Streak Harian 🔥",
    emoji: "⚡",
    subtitle: "Eksplorasi yang Menghasilkan Reward",
    description: "Buka sektor grid peta baru setiap hari untuk mempertahankan Streak dan mengklaim multiplier XP bonus level istimewa!",
    gradient: ["#F953C6", "#B91D73"],
  },
  {
    id: "step-4",
    title: "Privasi Tanpa Khawatir 🛡️",
    emoji: "🤫",
    subtitle: "Anda Pegang Kendali Penuh",
    description: "Gunakan Ghost Zones atau set Invisible Hours untuk memburamkan lokasi Anda secara otomatis demi kenyamanan penuh Anda.",
