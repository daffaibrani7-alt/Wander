...
export interface Conversation {
  ...
  groupEmoji?: string;
  /** Optional social circle type */
  groupType?: "trip" | "hangout" | "family" | "close" | "exploration";
  /** Optional cover image/color theme key */
  coverImage?: string;
  /** Optional collaborative journey timeline */
  timeline?: { id: string; user: string; emoji: string; text: string; time: string }[];
  /** Optional live meetup active session */
  meetupLocation?: { latitude: number; longitude: number; placeName?: string; active: boolean };
  /** Optional collaborative memory cards generated by AI */
  aiMemories?: { id: string; title: string; imageTheme: string; description: string }[];
}
