  ...
  return [
    {
      ...
      lastMessage: {
        content: "Check out this new spot around Senopati! 🗺️",
        type: "text",
        senderUid: "sim-1",
        senderName: "Aria ✨",
    ...
    },
    {
      ...
      lastMessage: {
        content: "Where are we going this weekend? 🌴",
        type: "text",
        senderUid: "sim-3",
        senderName: "Luna 🌙",
      ...
      pinnedBy: [],
      mutedBy: [],
      groupName: "Squad Explore 🧭",
      groupEmoji: "🧭",
      groupType: "exploration",
      coverImage: "cyber",
      timeline: [
        { id: "tl-1", user: "Aria ✨", emoji: "🚶‍♀️", text: "Checked in at Senopati Coffee Shop", time: "2h ago" },
        { id: "tl-2", user: "Luna 🌙", emoji: "📍", text: "Dropped a collaborative meetup pin", time: "1h ago" },
        { id: "tl-3", user: "You", emoji: "🚗", text: "Started live driving exploration session", time: "30m ago" },
      ],
      meetupLocation: {
        latitude: -6.2088,
        longitude: 106.8456,
        placeName: "Senopati Meetup Point",
        active: true,
      },
      aiMemories: [
        { id: "am-1", title: "Midnight Rambles", imageTheme: "sunset", description: "A beautifully spontaneous drive through Kemang alleys, unlocking the legendary Midnight Rambler badge together." },
        { id: "am-2", title: "Pantai Indah Escapade", imageTheme: "neon", description: "Breathtaking coastline sunset memories with Raka and Aria, charting PIK food centers in high-spirits." },
      ],
    },
    {
      id: "sim-conv-4",
      type: "group",
      participantUids: [currentUid, "sim-1", "sim-2"],
      participantProfiles: {
        [currentUid]: selfProfile,
        "sim-1": SIM_PARTICIPANTS["sim-1"],
        "sim-2": SIM_PARTICIPANTS["sim-2"],
      },
      lastMessage: {
        content: "See you guys at the café! ☕",
        type: "text",
        senderUid: "sim-1",
        senderName: "Aria ✨",
      ...
      coverImage: "sunset",
      timeline: [
        { id: "tl-4", user: "Raka 🔥", emoji: "☕", text: "Spotted Raka chilling at Common Grounds Cafe", time: "1h ago" },
        { id: "tl-5", user: "Aria ✨", emoji: "👋", text: "Aria joined the hangout circle active session", time: "10m ago" },
      ],
      meetupLocation: {
        latitude: -6.2243,
        longitude: 106.8098,
        placeName: "Common Grounds Cafe",
        active: true,
      },
      aiMemories: [
        { id: "am-3", title: "Senopati Caffeine Crawl", imageTheme: "aurora", description: "3 coffee hops in a single afternoon. Pure social energy, lots of high-fives and active updates." },
      ],
    },
  ];
}
    ...
    return [
      {
        ...
        type: "text",
        content: "Hey Aria! Where are you? 👋",
        reactions: { "sim-1": "❤️" },
      ...
      },
      {
        ...
        senderUid: "sim-1",
        type: "text",
        content: "Just exploring Kemang area 🚶‍♀️",
        reactions: {},
      ...
      },
      {
        ...
        senderUid: currentUid,
        type: "text",
        content: "Oh cool! I'm planning to go there this afternoon too",
        reactions: {},
    ...
    return [
      {
        ...
        senderUid: currentUid,
        type: "text",
        content: "Bro, are we still exploring together?",
        reactions: {},
    ...
    return [
      {
        ...
        senderUid: "sim-1",
        type: "text",
        content: "Guys, there's a new spot at Pantai Indah Kapuk!",
      ...
      },
      {
        ...
        senderUid: currentUid,
        type: "text",
        content: "Seriously? Let's go there tomorrow",
        reactions: { "sim-1": "👍" },
