    ...
    return (
      <View style={styles.container}>
        <View style={styles.headerRow}>
          ...
          {onClose && (
            <Pressable onPress={onClose} style={styles.closeBtn} id="close-memories-empty">
              <Text style={[styles.closeBtnText, { color: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.4)" }]}>✕</Text>
            </Pressable>
          )}
        </View>
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerRow}>
        ...
        {onClose && (
          <Pressable onPress={onClose} style={styles.closeBtn} id="close-memories-active">
            <Text style={[styles.closeBtnText, { color: isDark ? "rgba(255,255,255,0.4)" : "rgba(0,0,0,0.4)" }]}>✕</Text>
          </Pressable>
        )}
      </View>
